" ir_white color scheme based on ir_black from http://blog.infinitered.com/entries/show/8
...
hi Cursor           guifg=black       guibg=lightgrey       gui=NONE      ctermfg=black       ctermbg=lightgrey       cterm=reverse
hi LineNr           guifg=#3D3D3D     guibg=black       gui=NONE      ctermfg=cyan    ctermbg=255        cterm=NONE
...
hi StatusLine     guifg=black       guibg=#202020     gui=NONE      ctermfg=yellow        ctermbg=darkgray    cterm=BOLD  

hi Folded           guifg=#a0a8b0     guibg=#384048     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
hi Title            guifg=#f6f3e8     guibg=NONE        gui=bold      ctermfg=NONE        ctermbg=NONE        cterm=NONE
hi Visual           guifg=NONE        guibg=#262D51     gui=NONE      ctermfg=NONE        ctermbg=227    cterm=NONE

hi SpecialKey       guifg=#808080     guibg=#343434     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE

hi WildMenu         guifg=green       guibg=white      gui=NONE      ctermfg=black       ctermbg=white      cterm=NONE
...
hi ModeMsg          guifg=black       guibg=#C6C5FE     gui=BOLD      ctermfg=yellow       ctermbg=darkgray        cterm=BOLD

if version >= 700 " Vim 7.x specific colors
  hi CursorLine     guifg=NONE        guibg=#121212     gui=NONE      ctermfg=NONE        ctermbg=255        cterm=NONE
  hi CursorColumn   guifg=NONE        guibg=#121212     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=BOLD
  hi MatchParen     guifg=#f6f3e8     guibg=#857b6f     gui=BOLD      ctermfg=NONE       ctermbg=cyan    cterm=BOLD
  hi Pmenu          guifg=#f6f3e8     guibg=#444444     gui=NONE      ctermfg=NONE        ctermbg=grey        cterm=NONE
  hi PmenuSel       guifg=#000000     guibg=#cae682     gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
  hi Search         guifg=NONE        guibg=NONE        gui=underline ctermfg=NONE        ctermbg=227        cterm=NONE
endif

" Syntax highlighting
hi Comment          guifg=#7C7C7C     guibg=NONE        gui=NONE      ctermfg=249    ctermbg=NONE        cterm=NONE
hi String           guifg=magenta     guibg=NONE        gui=NONE      ctermfg=126      ctermbg=NONE        cterm=NONE
hi Number           guifg=#FF73FD     guibg=NONE        gui=NONE      ctermfg=126     ctermbg=NONE        cterm=NONE
...
hi Todo   guifg=#8f8f8f     guibg=NONE        gui=NONE      ctermfg=white         ctermbg=201        cterm=BOLD
...
hi Special          guifg=#E18964     guibg=NONE        gui=NONE      ctermfg=magenta       ctermbg=NONE        cterm=NONE
hi Delimiter        guifg=#00A0A0     guibg=NONE        gui=NONE      ctermfg=blue        ctermbg=NONE        cterm=NONE
hi Operator         guifg=darkgray       guibg=NONE        gui=NONE      ctermfg=blue       ctermbg=NONE        cterm=BOLD
